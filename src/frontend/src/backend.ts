...
export class Backend implements backendInterface {
    ...
    async getTopKills(): Promise<Array<Entry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopKills();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopPlacements(): Promise<Array<Entry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopPlacements();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitMatch(arg0: string, arg1: bigint, arg2: bigint, arg3: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitMatch(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
